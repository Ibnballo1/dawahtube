export interface NewsItem {
  ...
  export const newsItems: NewsItem[] = [
    ...
    },
    {
      ...
      excerpt: "Religious leaders from various faiths gather to discuss common values and promote peaceful coexistence.",
      content: "The annual Interfaith Dialogue Summit brought together leaders from different religious communities...",
      category: "interfaith",
    ...
    },
    {
      ...
      excerpt: "Young Muslim leaders will gather for intensive training in community leadership and Islamic principles.",
      content: "The Youth Islamic Leadership Conference will take place this summer, featuring workshops and seminars...",
      category: "youth",
