export interface Article {
  ...
  export const articles: Article[] = [
    ...
    },
    {
      ...
      excerpt: "Exploring the 99 beautiful names of Allah and their profound meanings in our daily spiritual journey.",
      content:
    ...
    },
    {
      ...
      excerpt: "Discover the wisdom of prophetic medicine and natural remedies mentioned in Islamic traditions.",
      content:
    ...
    },
    {
      ...
      excerpt: "Learn about the various forms of dhikr and how remembrance of Allah can transform your spiritual state.",
      content:
  ...
  export const categories = [
    ...
    { id: "aqeedah", name: "Aqeedah", count: articles.filter((a) => a.category === "aqeedah").length },
    { id: "hadith", name: "Hadith", count: articles.filter((a) => a.category === "hadith").length },
    { id: "fiqh", name: "Fiqh", count: articles.filter((a) => a.category === "fiqh").length },
    { id: "quran", name: "Quran Studies", count: articles.filter((a) => a.category === "quran").length },
    { id: "history", name: "Islamic History", count: articles.filter((a) => a.category === "history").length },
    {
      id: "contemporary",
      name: "Contemporary Issues",
      count: articles.filter((a) => a.category === "contemporary").length,
    },
    { id: "spirituality", name: "Spirituality", count: articles.filter((a) => a.category === "spirituality").length },
  ]
