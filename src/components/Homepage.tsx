...
import { ArrowRight, BookOpen, Headphones, MessageCircle, Star, Clock, User, Play, Download } from "lucide-react"
...
export default function HomePage() {
  ...
  const featuredAudio = audioLectures.filter((lecture) => lecture.featured).slice(0, 3)
    ...
    <div className="min-h-screen">
          ...
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Discover insightful articles on Islamic teachings and contemporary issues
              </p>
            </div>
            <Link href="/articles">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Featured Audio Lectures</h2>
              <p className="text-gray-600 text-lg">Listen to inspiring lectures from renowned Islamic scholars</p>
            </div>
            <Link href="/audio">
              <Button variant="outline" className="hidden md:flex bg-transparent">
                View All Lectures
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredAudio.map((lecture) => (
              <Card key={lecture.id} className="group hover:shadow-lg transition-shadow duration-300">
                <CardHeader>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Latest Islamic News</h2>
              <p className="text-gray-600 text-lg">Stay updated with the latest news from the Muslim community</p>
            </div>
            <Link href="/news">
              <Button variant="outline" className="hidden md:flex bg-transparent">
                View All News
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {latestNews.map((news) => (
              <Card key={news.id} className="group hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                <div className="aspect-video bg-gradient-to-br from-primary-light to-primary overflow-hidden">
                  <img
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Popular Q&A</h2>
              <p className="text-gray-600 text-lg">Get answers to common Islamic questions from qualified scholars</p>
            </div>
            <Link href="/qa">
              <Button variant="outline" className="hidden md:flex bg-transparent">
                View All Q&A
            ...
            {popularQA.map((qa) => (
              <Card key={qa.id} className="group hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent>
                  ...
                  <Link href={`/qa/${qa.id}`}>
                    <Button variant="ghost" size="sm" className="mt-4 text-primary hover:text-primary-dark">
                      Read Full Answer
                      <ArrowRight className="ml-1 h-4 w-4" />
                    </Button>
                  </Link>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-dark text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Subscribe to our newsletter and stay updated with the latest Islamic content, articles, and lectures.
          </p>
